import { LayoutDashboard, Wallet, WalletCards, Receipt, CreditCard, Landmark, PiggyBank, Settings, Trash2, FileText, Gift, Target } from 'lucide-react';
...
export const NAV_ITEMS = [
  ...
  { id: Page.GOALS, label: 'Goals', icon: <Target className="w-5 h-5" />, path: "/goals" },
